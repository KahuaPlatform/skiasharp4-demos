...
- Different SkiaSharp versions per demo are explicitly allowed (UnoGallery and KahuaNetwork still pin SkiaSharp 3 while the arcade family + Launcher pin SkiaSharp 4 preview).
