...
public static class Renderer
{
    ...
    static readonly SKImage? KahuaSnowflakeImage = LoadEmbeddedImage("UnoGalaga.Assets.Icons.kahua_snowflake.png");
    ...
    const string MarqueeText = "UNOGALAGA · UNO PLATFORM · SKIASHARP 4 · NEON SHMUP DEMO";
    ...
    // --- Neon primitive helpers (mirrors the pattern from UnoAsteroids) ---
    ...
    // ported verbatim from the UnoAsteroids marquee implementation.
